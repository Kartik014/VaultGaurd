...
interface DatabaseConnectionInterface {
    ...
    fun addDataToDB(addRowDataDTO: AddRowDataDTO): ApiResponse<Map<String, Any>>

    fun removeDataFromDB(removeRowDataDTO: RemoveRowDataDTO): ApiResponse<Map<String, Any>>
